...
```bash
npm install -g git+ssh://git@repo.nyc.foxnews.com:7999/orion/markdown-editor.git
```
...
```bash
npm install git+ssh://git@repo.nyc.foxnews.com:7999/orion/markdown-editor.git
```
